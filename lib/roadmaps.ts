...
export const commonwealthRoadmap = [
  { id: 1, title: "Overview & Development Mandate", desc: "Fully funded by UK FCDO. You must return to India. Targets development outcomes and explicitly considers financial need.", checklist: ["Understand development focus", "Check MBA exclusion rule"] },
  { id: 2, title: "Two-Layer Eligibility", desc: "Must meet both CSC universal criteria and MoE India-specific criteria.", checklist: ["Verify 60/65% minimum marks", "Prepare EWS certificate if applicable"] },
  { id: 3, title: "Financial Coverage & Upfront Costs", desc: "£1,378-£1,652/mo stipend. Note: Visa and IHS costs (~£1,266) must be paid upfront by you.", checklist: ["Budget for upfront Visa/IHS costs", "Review monthly living stipend"] },
  { id: 4, title: "Two-Portal Timeline", desc: "You must apply via BOTH the CSC portal and the MoE SAKSHAT portal.", checklist: ["Note early Sept opening", "Set reminder for mid-Oct deadline"] },
  { id: 5, title: "Documents & Impact Statement", desc: "Prepare the critical 400-500 word Development Impact Statement connecting your study to an Indian problem.", checklist: ["Draft specific Impact Statement", "Contact 2 referees early for CSC links"] },
  { id: 6, title: "The Application Execution", desc: "Register on CSC OAS and submit. Then register on MoE SAKSHAT and submit.", checklist: ["Submit primary CSC application", "Submit secondary MoE application"] },
  { id: 7, title: "Interview Preparation", desc: "Prepare for potential MoE shortlisting interview focusing heavily on your return plan.", checklist: ["Practice Impact Statement answers", "Define specific return role/organization"] },
  { id: 8, title: "University Selection", desc: "Apply to 2-3 UK universities simultaneously to secure a conditional offer.", checklist: ["Find development-aligned courses", "Secure conditional university offer"] },
