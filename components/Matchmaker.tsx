...
export default function Matchmaker() {
  ...
  return (
    <>
      ...
      {/* The Modal Overlay */}
      {isOpen && (
        <div className="fixed inset-0 z- flex items-center justify-center p-4 bg-background/80 backdrop-blur-md animate-in fade-in duration-300">
