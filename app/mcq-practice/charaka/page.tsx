    ...
    <div className="min-h-screen bg-background relative overflow-hidden transition-colors duration-300 pt-12 pb-24 px-6">
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="bg-surface/80 backdrop-blur-md border border-surfaceBorder p-8 md:p-12 mb-10 rounded-sm shadow-xl relative overflow-hidden">
          ...
          <BookOpen className="w-12 h-12 text-amber-500 mb-6 relative z-10" />
          ...
          <p className="text-lg text-foreground/70 font-medium max-w-2xl relative z-10">
            Access all your 20-question rapid revision practice papers here.
          </p>
        </div>

        <div className="mb-12">
          <h2 className="text-2xl font-heading font-bold text-foreground mb-6 flex items-center gap-2">
            <BookOpen className="w-6 h-6 text-amber-500" /> Practice Papers
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            
            {/* Charaka Test 1 (ACTIVE) */}
            <Link href="/mcq-practice/charaka/test-1" className="group bg-surface/80 backdrop-blur-sm border border-surfaceBorder rounded-sm p-6 flex items-center justify-between hover:border-amber-500/50 hover:shadow-lg transition-all duration-300">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h3 className="font-bold text-foreground text-xl mb-1">Practice Paper 1</h3>
                  <p className="text-foreground/50 font-medium text-sm">Questions 1 - 20</p>
                </div>
              </div>
            ...
            {/* Charaka Test 2 (ACTIVE) */}
            <Link href="/mcq-practice/charaka/test-2" className="group bg-surface/80 backdrop-blur-sm border border-surfaceBorder rounded-sm p-6 flex items-center justify-between hover:border-amber-500/50 hover:shadow-lg transition-all duration-300">
              <div className="flex items-center gap-5">
                <div className="w-14 h-14 bg-amber-500/10 rounded-sm flex items-center justify-center shrink-0 border border-amber-500/20 group-hover:bg-amber-500/20 transition-colors">
                  <BookOpen className="w-6 h-6 text-amber-500" />
                </div>
                <div>
                  <h3 className="font-bold text-foreground text-xl mb-1">Practice Paper 2</h3>
            ...
            <div className="bg-surface/40 backdrop-blur-sm border border-dashed border-surfaceBorder rounded-sm p-6 flex items-center justify-between opacity-70 cursor-not-allowed">
              <div className="flex items-center gap-5">
                ...
                <div>
                  <h3 className="font-bold text-foreground/60 text-xl mb-1">Practice Paper 3</h3>
