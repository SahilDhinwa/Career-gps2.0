...
const OFFICIAL_TESTS = [
  { id: "batch-2023", title: "DG Paper 1 - 2023 (Main)", subtitle: "Previous Year University Question Paper • 20 Questions", link: "/mcq-practice/dravyaguna/paper-1/university-papers/batch-2023" },
  { id: "batch-2022", title: "DG Paper 1 - 2022 (Main)", subtitle: "Previous Year University Question Paper • 20 Questions", link: "/mcq-practice/dravyaguna/paper-1/university-papers/batch-2022" },
  { id: "batch-2021", title: "DG Paper 1 - 2021 (Main)", subtitle: "Previous Year University Question Paper • 20 Questions", link: "/mcq-practice/dravyaguna/paper-1/university-papers/batch-2021" }
];

export default function Paper1UniversityPapers() {
  return (
