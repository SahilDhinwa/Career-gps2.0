        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6">
          ...
          <div className="flex overflow-x-auto gap-4 md:gap-6 pb-8 pt-4 scrollbar-hide -mx-4 px-4 md:mx-0 md:px-0 snap-x snap-mandatory">
            ...
            <div className="group relative w-64 md:w-72 shrink-0 aspect-[9/16] rounded-xl overflow-hidden snap-center shadow-lg border border-surfaceBorder cursor-pointer transform transition-transform hover:-translate-y-2">
              ...
              <div className="absolute bottom-0 left-0 w-full p-5">
                <div className="flex items-center gap-2 text-white/80 text-xs font-bold mb-2">
                  <Eye className="w-3.5 h-3.5" /> 124K Views
                </div>
                <h3 className="text-white font-bold text-lg leading-snug drop-shadow-md">
                  The 'Captain America' Leadership Framework for SOPs
                </h3>
              </div>
            </div>
            ...
            <div className="group relative w-64 md:w-72 shrink-0 aspect-[9/16] rounded-xl overflow-hidden snap-center shadow-lg border border-surfaceBorder cursor-pointer transform transition-transform hover:-translate-y-2">
              ...
              <div className="absolute bottom-0 left-0 w-full p-5">
                <div className="flex items-center gap-2 text-white/80 text-xs font-bold mb-2">
                  <Eye className="w-3.5 h-3.5" /> 89K Views
                </div>
                <h3 className="text-white font-bold text-lg leading-snug drop-shadow-md">
                  Viral SEO Strategies for Your University Application
                </h3>
              </div>
            </div>
            ...
            <div className="group relative w-64 md:w-72 shrink-0 aspect-[9/16] rounded-xl overflow-hidden snap-center shadow-lg border border-surfaceBorder cursor-pointer transform transition-transform hover:-translate-y-2">
              ...
              <div className="absolute bottom-0 left-0 w-full p-5">
                <div className="flex items-center gap-2 text-white/80 text-xs font-bold mb-2">
                  <Eye className="w-3.5 h-3.5" /> 210K Views
                </div>
                <h3 className="text-white font-bold text-lg leading-snug drop-shadow-md">
                  3 Mistakes Killing Your Chevening Scholarship Chances
                </h3>
              </div>
            </div>
            ...
            {/* Reel 4 */}
            <div className="group relative w-64 md:w-72 shrink-0 aspect-[9/16] rounded-xl overflow-hidden snap-center shadow-lg border border-surfaceBorder cursor-pointer transform transition-transform hover:-translate-y-2">
              <div className="absolute inset-0 bg-gradient-to-br from-indigo-950 to-black"></div>
              <div className="absolute inset-0 bg-gradient-to-t from-black via-black/40 to-transparent"></div>
              ...
              <div className="absolute bottom-0 left-0 w-full p-5">
                <div className="flex items-center gap-2 text-white/80 text-xs font-bold mb-2">
                  <Eye className="w-3.5 h-3.5" /> 156K Views
                </div>
                <h3 className="text-white font-bold text-lg leading-snug drop-shadow-md">
                  How to Build an Elite Profile from a Tier-3 City
                </h3>
              </div>
            </div>
